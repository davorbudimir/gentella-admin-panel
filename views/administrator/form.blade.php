...
@section('head')
    @parent
    @section('title', 'Form')
  <link href="administratorjs/css/editor/external/google-code-prettify/prettify.css" rel="stylesheet">
  <link href="administratorjs/css/editor/index.css" rel="stylesheet">
  <link href="administratorjs/css/select/select2.min.css" rel="stylesheet">
  <link rel="stylesheet" href="administratorjs/css/switchery/switchery.min.css" />
@stop
...
@section('javascript')
  <script src="administrator/js/tags/jquery.tagsinput.min.js"></script>
  <script src="administrator/js/switchery/switchery.min.js"></script>
  <script type="text/javascript" src="administrator/js/moment/moment.min.js"></script>
  <script type="text/javascript" src="administrator/js/datepicker/daterangepicker.js"></script>
  <script src="administrator/js/editor/bootstrap-wysiwyg.js"></script>
  <script src="administrator/js/editor/external/jquery.hotkeys.js"></script>
  <script src="administrator/js/editor/external/google-code-prettify/prettify.js"></script>
  <script src="administrator/js/select/select2.full.js"></script>
  <script type="text/javascript" src="administrator/js/parsley/parsley.min.js"></script>
  <script src="administrator/js/textarea/autosize.min.js"></script>
  <script>
    autosize($('.resizable_textarea'));
  </script>
  <script type="text/javascript" src="administrator/js/autocomplete/countries.js"></script>
  <script src="administrator/js/autocomplete/jquery.autocomplete.js"></script>
