...
@section('javascript')
  <!-- worldmap -->
  <script type="text/javascript" src="administrator/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
  <script type="text/javascript" src="administrator/js/maps/gdp-data.js"></script>
  <script type="text/javascript" src="administrator/js/maps/jquery-jvectormap-world-mill-en.js"></script>
  <script type="text/javascript" src="administrator/js/maps/jquery-jvectormap-us-aea-en.js"></script>

  <!-- chart js -->
  <script src="administrator/js/moment/moment.min.js"></script>
  <script src="administrator/js/chartjs/chart.min.js"></script>
  
    <!-- sparkline -->
  <script src="administrator/js/sparkline/jquery.sparkline.min.js"></script>
  
   <!-- easypie -->
  <script src="administrator/js/easypie/jquery.easypiechart.min.js"></script>
