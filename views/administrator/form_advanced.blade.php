                ...
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <div class="img-container">
                      <img src="administrator/images/picture2.jpg" alt="Picture">
                    </div>
                  </div>
                  <div class="col-md-3">
...
@section('javascript')
  <!-- input mask -->
  <script src="administrator/js/input_mask/jquery.inputmask.js"></script>
  <script>
   ...
   <!-- knob -->
  <script src="administrator/js/knob/jquery.knob.min.js"></script>
  <script>
    $(function($) {
  ...
  <script src="administrator/js/cropping/main2.js"></script>
